...
} from "./chunk-JVK75IAD.js";
import {
  $3017fa7ffdddec74$export$8042c6c013fd5226
} from "./chunk-4DJFQIQP.js";
import {
...
function $406796ff087fe49b$export$e375f10ce42261c5(props, state, inputRef) {
  ...
  return {
    labelProps: (0, $3ef42575df84b30b$export$9d1611c77c2fe928)(labelProps, pressProps, (0, import_react.useMemo)(() => ({
...
function CheckIcon(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(
    "svg",
    {
      ...
      viewBox: "0 0 17 18",
      ...otherProps,
      children: (0, import_jsx_runtime2.jsx)("polyline", { points: "1 9 7 14 15 4" })
    }
  );
}
...
function useCheckbox(props = {}) {
  ...
  const domRef = (0, import_react7.useRef)(null);
  ...
  const labelId = (0, import_react6.useId)();
  const ariaCheckboxProps = (0, import_react7.useMemo)(
    () => ({
      name,
      value,
      children,
...
var Checkbox = forwardRef((props, ref) => {
  ...
  const clonedIcon = typeof icon === "function" ? icon(getIconProps()) : (0, import_react8.cloneElement)(icon, getIconProps());
