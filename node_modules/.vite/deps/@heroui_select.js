...
import {
  useIsMobile
} from "./chunk-TJJY2RHJ.js";
import {
  TRANSITION_VARIANTS
} from "./chunk-QRFZVZ7J.js";
import {
  button_default
} from "./chunk-M7RNRXJP.js";
import {
  spinner_default
} from "./chunk-PXHTQPDW.js";
import {
  useAriaButton
} from "./chunk-6XJY3VPT.js";
import {
  ChevronDownIcon,
  CloseFilledIcon
} from "./chunk-XH4H2C3C.js";
import {
  $2baaea4c71418dea$export$294aa081a6c6f55d,
  $d191a55c9702f145$export$8467354a121f1b9f,
  $e93e671b31057976$export$b8473d3665f3a75a
} from "./chunk-US2L337X.js";
import {
  $e5be200c675c3b3a$export$fc1a364ae1f3ff10,
  FormContext,
  useSlottedContext
} from "./chunk-6ZUO4B3Y.js";
import {
  useSafeLayoutEffect
} from "./chunk-7YU5YOWR.js";
import {
...
var $eb2240fc39a57fa5$export$bf788dd355e3a401 = class {
  ...
  *iterateCollection(props) {
    ...
    if ((0, import_react4.default).isValidElement(children) && children.type === (0, import_react4.default).Fragment) yield* this.iterateCollection({
  ...
  *getFullNode(partialNode, state, parentKey, parentNode) {
    if ((0, import_react4.default).isValidElement(partialNode.element) && partialNode.element.type === (0, import_react4.default).Fragment) {
      let children = [];
      (0, import_react4.default).Children.forEach(partialNode.element.props.children, (child) => {
        children.push(child);
      });
...
function $e72dd72e1c76a225$export$2f645645f7bca764(props) {
  ...
  let factory = (0, import_react6.useCallback)((nodes) => filter ? new (0, $a02d57049d202695$export$d085fb9e920b5ca7)(filter(nodes)) : new (0, $a02d57049d202695$export$d085fb9e920b5ca7)(nodes), [
    filter
  ]);
  ...
  let selectionManager = (0, import_react6.useMemo)(() => new (0, $d496c0a20b6e58ec$export$6c8a5aaad13c9852)(collection, selectionState, {
    layoutDelegate
  }), [
    collection,
    selectionState,
...
function $e72dd72e1c76a225$var$useFocusedKeyReset(collection, selectionManager) {
  const cachedCollection = (0, import_react6.useRef)(null);
...
function useMultiSelectListState(props) {
  ...
  const missingKeys = (0, import_react8.useMemo)(() => {
...
function $a28c903ee9ad8dc5$export$79fefeb1c2091ac3(props) {
  ...
  let [focusStrategy, setFocusStrategy] = (0, import_react10.useState)(null);
  let [expandedKeysStack, setExpandedKeysStack] = (0, import_react10.useState)([]);
  let closeAll = () => {
...
function useMultiSelectState({
  ...
  const [isFocused, setFocused] = (0, import_react12.useState)(false);
  const [focusStrategy, setFocusStrategy] = (0, import_react12.useState)(null);
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
  ...
  let shouldVirtualFocusFirst = (0, import_react14.useRef)(false);
  ...
  const didAutoFocusRef = (0, import_react14.useRef)(false);
  ...
  let raf = (0, import_react14.useRef)(null);
  (0, import_react14.useEffect)(() => {
...
function $880e95eb8b93ba9a$export$ecf600387e221c37(options) {
  ...
  let modality = (0, import_react15.useRef)(null);
  let longPressEnabled = hasAction && allowsSelection;
  let longPressEnabledOnPressStart = (0, import_react15.useRef)(false);
  let hadPrimaryActionOnPressStart = (0, import_react15.useRef)(false);
...
function $982254629710d113$export$b95089534ab7c1fd(props) {
  ...
  let delegate = (0, import_react16.useMemo)(() => keyboardDelegate || new (0, $2a25aae57d74318e$export$a05409b8bb224a5a)({
    collection,
    disabledKeys,
    disabledBehavior,
    ref,
...
function useMultiSelect(props, state, ref) {
  ...
  const delegate = (0, import_react20.useMemo)(
...
function useSelect(originalProps) {
  ...
  const getTriggerProps = (0, import_react21.useCallback)(
    (props2 = {}) => {
      return {
        ref: triggerRef,
        "data-slot": "trigger",
  ...
  const getHiddenSelectProps = (0, import_react21.useCallback)(
    (props2 = {}) => ({
      state,
      triggerRef,
      selectRef: domRef,
  ...
  const getValueProps = (0, import_react21.useCallback)(
    (props2 = {}) => ({
      "data-slot": "value",
  ...
  const getListboxWrapperProps = (0, import_react21.useCallback)(
    (props2 = {}) => ({
  ...
  const getPopoverProps = (0, import_react21.useCallback)(
    (props2 = {}) => {
      var _a2, _b2;
  ...
  const getSelectorIconProps = (0, import_react21.useCallback)(
    () => ({
  ...
  const getInnerWrapperProps = (0, import_react21.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getHelperWrapperProps = (0, import_react21.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getDescriptionProps = (0, import_react21.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
        ...descriptionProps,
  ...
  const getMainWrapperProps = (0, import_react21.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getEndWrapperProps = (0, import_react21.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getEndContentProps = (0, import_react21.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getClearButtonProps = (0, import_react21.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
        type: "button",
...
var useLayoutEffect = typeof document !== "undefined" ? import_react22.default.useLayoutEffect : () => {
};
...
function useListbox(props) {
  ...
  const slots = (0, import_react23.useMemo)(() => menu(), []);
  const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
...
function useListboxItem(originalProps) {
  ...
  const getSelectedIconProps = (0, import_react24.useCallback)(
    (props2 = {}) => {
      return {
        "aria-hidden": dataAttr(true),
        "data-disabled": dataAttr(isDisabled),
...
var ListboxItem = (props) => {
  ...
  const selectedContent = (0, import_react25.useMemo)(() => {
...
function useDivider(props) {
  ...
  const getDividerProps = (0, import_react26.useCallback)(
    (props2 = {}) => ({
      className: styles,
      role: "separator",
...
var ListboxSection = forwardRef(
  ({
    ...
    const slots = (0, import_react27.useMemo)(() => menuSection(), []);
    const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
...
function useDataScrollOverflow(props = {}) {
  ...
  const visibleRef = (0, import_react29.useRef)(visibility);
...
function useScrollShadow(originalProps) {
  ...
  const styles = (0, import_react30.useMemo)(
    () => scrollShadow({
      ...variantProps,
      className
    }),
...
var VirtualizedListbox = (props) => {
  ...
  const itemSizes = (0, import_react28.useMemo)(
  ...
  const [scrollState, setScrollState] = (0, import_react28.useState)({
    isTop: false,
    isBottom: true,
    isMiddle: false
  });
...
function usePopover(originalProps) {
  ...
  const Component = as || "div";
  const domRef = useDOMRef(ref);
  const domTriggerRef = (0, import_react33.useRef)(null);
  const wasTriggerPressedRef = (0, import_react33.useRef)(false);
  ...
  const placement = (0, import_react33.useMemo)(() => {
    if (!ariaPlacement) {
      return null;
    }
  ...
  const onPress = (0, import_react33.useCallback)(
    (e) => {
      var _a2;
      let pressTimer;
  ...
  const getTriggerProps = (0, import_react33.useCallback)(
    (props2 = {}, _ref = null) => {
  ...
  const getBackdropProps = (0, import_react33.useCallback)(
    (props2 = {}) => ({
      "data-slot": "backdrop",
...
function $40df3f8667284809$export$d55e7ee900f34e93(props, ref) {
  ...
  let isRefocusing = (0, import_react34.useRef)(false);
...
var domAnimation = () => import("./dist-FHGRUIY5.js").then((res) => res.default);
...
var FreeSoloPopover = forwardRef(
  ({ children, transformOrigin, disableDialogFocus = false, ...props }, ref) => {
    ...
    const backdropContent = React3.useMemo(() => {
...
var domAnimation2 = () => import("./dist-FHGRUIY5.js").then((res) => res.default);
var PopoverContent = (props) => {
  ...
  const content = children && (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
  ...
  const backdropContent = (0, import_react35.useMemo)(() => {
    if (backdrop === "transparent") {
      return null;
    }
    if (disableAnimation) {
...
var PopoverTrigger = (props) => {
  ...
  const child = (0, import_react36.useMemo)(() => {
    if (typeof children === "string") return (0, import_jsx_runtime10.jsx)("p", { children });
    return import_react36.Children.only(children);
  }, [children]);
  const childRef = (_a = child.props.ref) != null ? _a : child.ref;
  const { onPress, isDisabled, ...restProps } = (0, import_react36.useMemo)(() => {
  ...
  const hasHeroUIButton = (0, import_react36.useMemo)(() => {
...
var Popover = forwardRef((props, ref) => {
  ...
  const [trigger, content] = import_react37.Children.toArray(children);
...
function useDataScrollOverflow2(props = {}) {
  ...
  const visibleRef = (0, import_react38.useRef)(visibility);
...
var ScrollShadow = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime12.jsx)(Component, { ...getBaseProps(), children });
});
...
var Select = forwardRef(function Select2(props, ref) {
  ...
  const {
    ...
    isLoading,
    triggerRef,
    selectorIcon = (0, import_jsx_runtime13.jsx)(ChevronDownIcon, {}),
    description,
    errorMessage,
    isInvalid,
    startContent,
  ...
  const labelContent = label ? (0, import_jsx_runtime13.jsx)("label", { ...getLabelProps(), children: label }) : null;
  const clonedIcon = (0, import_react41.cloneElement)(selectorIcon, getSelectorIconProps());
  const clearButton = (0, import_react40.useMemo)(() => {
    var _a2;
    if (isClearable && ((_a2 = state.selectedItems) == null ? void 0 : _a2.length)) {
      return (0, import_jsx_runtime13.jsx)("span", { ...getClearButtonProps(), children: (0, import_jsx_runtime13.jsx)(CloseFilledIcon, {}) });
    }
    return null;
  }, [isClearable, getClearButtonProps, (_a = state.selectedItems) == null ? void 0 : _a.length]);
  const end = (0, import_react40.useMemo)(() => {
    if (clearButton) {
      return (0, import_jsx_runtime13.jsxs)("div", { ...getEndWrapperProps(), children: [
        clearButton,
        endContent && (0, import_jsx_runtime13.jsx)("span", { ...getEndContentProps(), children: endContent })
      ] });
    }
    return endContent && (0, import_jsx_runtime13.jsx)("span", { ...getEndContentProps(), children: endContent });
  }, [clearButton, endContent, getEndWrapperProps, getEndContentProps]);
  const helperWrapper = (0, import_react40.useMemo)(() => {
    const shouldShowError = isInvalid && errorMessage;
    const hasContent = shouldShowError || description;
    if (!hasHelper || !hasContent) return null;
    return (0, import_jsx_runtime13.jsx)("div", { ...getHelperWrapperProps(), children: shouldShowError ? (0, import_jsx_runtime13.jsx)("div", { ...getErrorMessageProps(), children: errorMessage }) : (0, import_jsx_runtime13.jsx)("div", { ...getDescriptionProps(), children: description }) });
  }, [
    hasHelper,
    isInvalid,
    errorMessage,
  ...
  const renderSelectedItem = (0, import_react40.useMemo)(() => {
    var _a2;
  ...
  const renderIndicator = (0, import_react40.useMemo)(() => {
    if (isLoading) {
      return (0, import_jsx_runtime13.jsx)(spinner_default, { ...getSpinnerProps() });
    }
    return clonedIcon;
  }, [isLoading, clonedIcon, getSpinnerProps]);
  const popoverContent = (0, import_react40.useMemo)(
    () => state.isOpen ? (0, import_jsx_runtime13.jsx)(free_solo_popover_default, { ...getPopoverProps(), children: (0, import_jsx_runtime13.jsx)(scroll_shadow_default, { ...getListboxWrapperProps(), children: (0, import_jsx_runtime13.jsx)(listbox_default, { ...getListboxProps() }) }) }) : null,
  ...
  return (0, import_jsx_runtime13.jsxs)("div", { ...getBaseProps(), children: [
    (0, import_jsx_runtime13.jsx)(HiddenSelect, { ...getHiddenSelectProps() }),
    shouldLabelBeOutside ? labelContent : null,
    (0, import_jsx_runtime13.jsxs)("div", { ...getMainWrapperProps(), children: [
      (0, import_jsx_runtime13.jsxs)(Component, { ...getTriggerProps(), children: [
        !shouldLabelBeOutside ? labelContent : null,
        (0, import_jsx_runtime13.jsxs)("div", { ...getInnerWrapperProps(), children: [
          startContent,
          (0, import_jsx_runtime13.jsx)("span", { ...getValueProps(), children: renderSelectedItem }),
          endContent && state.selectedItems && (0, import_jsx_runtime13.jsx)($5c3e21d68f1c4674$export$439d29a4e110a164, { elementType: "span", children: "," }),
          end
        ] }),
        renderIndicator
      ] }),
    ...
    disableAnimation ? popoverContent : (0, import_jsx_runtime13.jsx)(AnimatePresence, { children: popoverContent })
  ] });
});
